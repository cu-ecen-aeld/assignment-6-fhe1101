...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-fhe1101;protocol=ssh;branch=main"

PV = "1.0+git${SRCPV}"
# set to reference a specific commit hash in your assignment repo
SRCREV = "c811923859fe197df3d965cffabe14760458f6bb"
...
do_compile () {
	oe_runmake CC="${CC}" CFLAGS="${CFLAGS}" LDFLAGS="${LDFLAGS}" CROSS_COMPILE="${CROSS_COMPILE}"
}
...
do_install () {
	...
	install -m 0755 ${S}/aesdsocket-start-stop ${D}${bindir}/aesdsocket-start-stop
